...
The last C4.5 decision tree to explore is a model using the leave-one-out training method.

```{r dt-c4_5_loo_train-h_a}
dt.c4_5_loo_a <- train(dt.formula, method="J48", abalone_data_cleansed_age_groups, tuneLength = 8, trControl = loocv.train_control)
```

#####J48, leave-one-out training results

```{r dt-c4_5_loo_train-h_a_results}
dt_sum.c4_5_loo_a <- summary(dt.c4_5_loo_a)
dt_sum.c4_5_loo_a_final <- summary(dt.c4_5_loo_a$finalModel)
#
dt_sum.c4_5_loo_a
#
dt.c4_5_loo_a_finalModel <- dt.c4_5_loo_a$finalModel
dt.c4_5_loo_a_finalModel_party <- as.party(dt.c4_5_loo_a_finalModel)
#
length(dt.c4_5_loo_a_finalModel_party)
width(dt.c4_5_loo_a_finalModel_party)
depth(dt.c4_5_loo_a_finalModel_party)
#
plot(dt.c4_5_loo_a_finalModel_party)
```


```{r c4_5_cv-pcCorrect}
dt_sum.c4_5_loo_a$details[1]
```

#####J48, leave-one-out training results

```{r dt-c4_5h2_test}
dt.c4_5_loo_a_test <- predict(dt.c4_5_loo_a, newdata = holdout_age_groups.testing)
dt.c4_5_loo_a_test_cm <- confusionMatrix(dt.c4_5_loo_a_test, holdout_age_groups.testing$age_group)
dt.c4_5_loo_a_test_cm$table
dt.c4_5_loo_a_test_cm$overall[1]
```
