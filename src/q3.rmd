...
The accuracy has improved markedly....

todo... this is our baseline, now we want to quickly train and test the same dataset but with the cross-validation, and jack-knife train & test options.
