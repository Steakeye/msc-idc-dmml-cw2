...
The data was checked to see if there were any missing values but it's also worth checking of some values are technically impossible and therefore belonging to incorrect entries that need to be removed; to do this, all values are iterated over to check for assignments of 0, indicating bad data [@doc:5a52ca43e4b02942103f7d57].
