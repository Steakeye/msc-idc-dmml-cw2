...
As an addition, the dataset modified to have an age_group factor attrbiute instead of rings attrbute of intergers, will also be partitioned for use with the holdout method.
